...
namespace alp {
	...
	class Matrix< T, Structure, density, View, ImfR, ImfC, reference > :
		public internal::matrix_base_class< T, Structure, Density::Dense, View, ImfR, ImfC, reference >::type {

		protected:
			typedef Matrix< T, Structure, Density::Dense, View, ImfR, ImfC, reference > self_type;
			...
			******************** */
			...
			template< typename fwd_iterator >
			friend RC buildMatrix( Matrix< T, Structure, Density::Dense, View, ImfR, ImfC, reference > & A,
		...
		public:
			 ...
			 */
			typedef typename internal::matrix_base_class< T, Structure, Density::Dense, View, ImfR, ImfC, reference >::type base_type;
			...
			struct view_type< view::original, d > {
				using type = Matrix< T, Structure, Density::Dense, view::Original< self_type >, imf::Id, imf::Id, reference >;
			};
