...
set( ALPGraphBLAS_AVAILABLE_BACKENDS reference;reference_omp;hyperdags;nonblocking )

# standard CMake dependencies
find_dependency( Threads REQUIRED )
find_dependency( OpenMP REQUIRED )

set( ALPGraphBLAS_WITH_BSP1D_BACKEND OFF )
set( ALPGraphBLAS_WITH_HYBRID_BACKEND OFF )
if( ALPGraphBLAS_WITH_BSP1D_BACKEND
	OR ALPGraphBLAS_WITH_HYBRID_BACKEND )
	find_dependency( MPI REQUIRED )
	# discover LPF from its own path
	find_package( LPF REQUIRED CONFIG PATHS "OFF/lib"
)
endif()
