	...
	namespace internal {
		...
		namespace hyperdags {
			...
			enum OperationVertexType {
				...
				EWISEADD_VECTOR_VECTOR_VECTOR_RING,
				EWISEADD_VECTOR_ALPHA_VECTOR_RING,
				EWISEADD_VECTOR_VECTOR_BETA_RING,
				EWISEADD_VECTOR_ALPHA_BETA_RING,
				EWISEADD_VECTOR_VECTOR_VECTOR_VECTOR_RING,
				EWISEADD_VECTOR_VECTOR_ALPHA_VECTOR_RING,
				EWISEADD_VECTOR_VECTOR_VECTOR_BETA_RING,
				EWISEADD_VECTOR_VECTOR_ALPHA_BETA_RING,
			...
			const constexpr size_t numOperationVertexTypes = 114;
