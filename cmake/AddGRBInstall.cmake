...
set( TUTORIAL_BACKEND_INSTALL_DIR "${BINARY_LIBRARIES_INSTALL_DIR}/tutorial" )
...
if( WITH_TUTORIAL_BACKEND )
	addBackendWrapperGenOptions( "tutorial"
	COMPILE_DEFINITIONS "${TUTORIAL_SELECTION_DEFS}"
	LINK_FLAGS "'${TUTORIAL_BACKEND_INSTALL_DIR}/lib${BACKEND_LIBRARY_OUTPUT_NAME}.a'"
		"'${ALP_UTILS_INSTALL_DIR}/lib${ALP_UTILS_LIBRARY_OUTPUT_NAME}.a'" "${NUMA_LFLAG}"
	)
endif()
