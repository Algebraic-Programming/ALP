...
namespace grb {
	...
	/**
	 * A GraphBLAS matrix, reference implementation. VOID SPECIALIZAITON
	 *
	 * Uses Compressed Column Storage (CCS) plus Compressed Row Storage (CRS).
	 *
	 * \warning This implementation prefers speed over memory efficiency.
	...
	template<
		...
		typename NonzeroIndexType
	>
	class Matrix< void, reference, RowIndexType, ColIndexType, NonzeroIndexType > {
		...
		friend const grb::Matrix<
			...
			ColIndexType, ColIndexType, NonzeroIndexType
		>
		internal::wrapCRSMatrix< void, ColIndexType, NonzeroIndexType, reference >(
	...
	template< typename RIT, typename CIT, typename NIT >
	struct is_container< Matrix< void, reference, RIT, CIT, NIT > > {
