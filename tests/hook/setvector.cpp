...
constexpr size_t b = config::CACHE_LINE_SIZE::value();

static bool check( const size_t s, const size_t P, const size_t global_index, const double * __restrict__ const parVec, const double equal_to, double & read, size_t & local_index ) {
...
void grbProgram( const size_t s, const size_t P, int & exit_status ) {
	...
	/*for( size_t i = 0; i < ((n/b+1)/3+1)*b; ++i ) {
