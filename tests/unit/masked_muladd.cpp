...
void grb_program( const size_t & n, grb::RC & rc ) {
	...
	rc = grb::eWiseMulAdd( z, m, alpha, x, y, ring );
	if( rc != SUCCESS ) {
	...
	rc = grb::eWiseMulAdd( z, m, a, beta, y, ring );
	if( rc != SUCCESS ) {
	...
	rc = grb::eWiseMulAdd( z, m, a, x, gamma, ring );
	if( rc != SUCCESS ) {
	...
	rc = grb::eWiseMulAdd( z, m, a, beta, gamma, ring );
	if( rc != SUCCESS ) {
	...
	rc = grb::eWiseMulAdd( z, m, alpha, x, gamma, ring );
	if( rc != SUCCESS ) {
	...
	rc = grb::eWiseMulAdd( z, m, alpha, beta, gamma, ring );
	if( rc != SUCCESS ) {
