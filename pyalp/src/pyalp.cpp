...
//PYBIND11_MODULE(pyalp, m) {
// Use a macro for the module name
#ifndef PYALP_MODULE_NAME
#define PYALP_MODULE_NAME pyalp
#endif
...
PYBIND11_MODULE(PYALP_MODULE_NAME, m) {
	...
	.def(py::init([](size_t m, size_t n,
	    ...
	    return matrix_factory<ScalarType>(m, n, data1, data2, data3);
	}),
	     py::arg("m"), py::arg("n"),
...
//m.def("buildMatrix", &buildMatrix, "Fill Matrix from 3 NumPy arrays"); // 
