...
namespace alp {
	 ...
	 */
	template< typename T, typename View, typename ImfR, typename ImfC >
	class Matrix< T, structures::Orthogonal, Density::Dense, View, ImfR, ImfC, reference > :
		public internal::matrix_base_class< T, structures::Orthogonal, Density::Dense, View, ImfR, ImfC, reference >::type {

		protected:
			typedef Matrix< T, structures::Orthogonal, Density::Dense, View, ImfR, ImfC, reference > self_type;
			...
			******************** */
			...
			template< typename fwd_iterator >
			friend RC buildMatrix( Matrix< T, structures::Orthogonal, Density::Dense, View, ImfR, ImfC, reference > & A,
				const fwd_iterator & start, const fwd_iterator & end );
		...
		public:
			/** Exposes the types and the static properties. */
			typedef structures::Orthogonal structure;
			/**
			 * Indicates if a matrix needs to allocate data-related memory
			 * (for the internal container or functor object).
			 * False if it is a view over another matrix or a functor.
			 ...
			 * the type of objects of this class to the base class type.
			 */
			typedef typename internal::matrix_base_class< T, structures::Orthogonal, Density::Dense, View, ImfR, ImfC, reference >::type base_type;
			...
			template < bool d >
			struct view_type< view::original, d > {
				using type = Matrix< T, structures::Orthogonal, Density::Dense, view::Original< self_type >, imf::Id, imf::Id, reference >;
			};
			...
			template < bool d >
			struct view_type< view::transpose, d > {
				using type = Matrix< T, structures::Orthogonal, Density::Dense, view::Transpose< self_type >, imf::Id, imf::Id, reference >;
			};
	 ...
	 */
	template< typename T, typename View, typename ImfR, typename ImfC >
	class Matrix< T, structures::Hermitian, Density::Dense, View, ImfR, ImfC, reference > :
		public internal::matrix_base_class< T, structures::Hermitian, Density::Dense, View, ImfR, ImfC, reference >::type {

		protected:
			typedef Matrix< T, structures::Hermitian, Density::Dense, View, ImfR, ImfC, reference > self_type;
			...
			******************** */
			...
			template< typename fwd_iterator >
			friend RC buildMatrix( Matrix< T, structures::Hermitian, Density::Dense, View, ImfR, ImfC, reference > & A,
				const fwd_iterator & start, const fwd_iterator & end );
		...
		public:
			/** Exposes the types and the static properties. */
			typedef structures::Hermitian structure;
			/**
			 * Indicates if a matrix needs to allocate data-related memory
			 * (for the internal container or functor object).
			 * False if it is a view over another matrix or a functor.
			 ...
			 * the type of objects of this class to the base class type.
			 */
			typedef typename internal::matrix_base_class< T, structures::Hermitian, Density::Dense, View, ImfR, ImfC, reference >::type base_type;
			...
			template < bool d >
			struct view_type< view::original, d > {
				using type = Matrix< T, structures::Hermitian, Density::Dense, view::Original< self_type >, imf::Id, imf::Id, reference >;
			};

			template < bool d >
			struct view_type< view::gather, d > {
				using type = Matrix< T, structures::Hermitian, Density::Dense, view::Gather< self_type >, imf::Strided, imf::Strided, reference >;
			};

			template < bool d >
			struct view_type< view::transpose, d > {
				using type = Matrix< T, structures::Hermitian, Density::Dense, view::Transpose< self_type >, imf::Id, imf::Id, reference >;
			};
	...
	/**
	 * @brief SymmetricTridiagonal matrix
	 */
	template< typename T, typename View, typename ImfR, typename ImfC >
	class Matrix< T, structures::SymmetricTridiagonal, Density::Dense, View, ImfR, ImfC, reference > :
		public internal::matrix_base_class< T, structures::SymmetricTridiagonal, Density::Dense, View, ImfR, ImfC, reference >::type {

		protected:
			typedef Matrix< T, structures::SymmetricTridiagonal, Density::Dense, View, ImfR, ImfC, reference > self_type;
			...
			******************** */
			...
			template< typename fwd_iterator >
			friend RC buildMatrix( Matrix< T, structures::SymmetricTridiagonal, Density::Dense, View, ImfR, ImfC, reference > & A,
				const fwd_iterator & start, const fwd_iterator & end );
		...
		public:
			/** Exposes the types and the static properties. */
			typedef structures::SymmetricTridiagonal structure;
			/**
			 * Indicates if a matrix needs to allocate data-related memory
			 * (for the internal container or functor object).
			 * False if it is a view over another matrix or a functor.
			 ...
			 * the type of objects of this class to the base class type.
			 */
			typedef typename internal::matrix_base_class< T, structures::SymmetricTridiagonal, Density::Dense, View, ImfR, ImfC, reference >::type base_type;
			...
			template < bool d >
			struct view_type< view::original, d > {
				using type = Matrix< T, structures::SymmetricTridiagonal, Density::Dense, view::Original< self_type >, imf::Id, imf::Id, reference >;
			};
			...
			template < bool d >
			struct view_type< view::transpose, d > {
				using type = Matrix< T, structures::SymmetricTridiagonal, Density::Dense, view::Transpose< self_type >, imf::Id, imf::Id, reference >;
			};
	...
	/**
	 * @brief LowerTriangular matrix with physical container.
	 */
	template< typename T, typename View, typename ImfR, typename ImfC >
	class Matrix< T, structures::LowerTriangular, Density::Dense, View, ImfR, ImfC, reference > :
		public internal::matrix_base_class< T, structures::LowerTriangular, Density::Dense, View, ImfR, ImfC, reference >::type {

		protected:
			typedef Matrix< T, structures::LowerTriangular, Density::Dense, View, ImfR, ImfC, reference > self_type;
			...
			******************** */
			...
			template< typename fwd_iterator >
			friend RC buildMatrix( Matrix< T, structures::LowerTriangular, Density::Dense, View, ImfR, ImfC, reference > & A,
				const fwd_iterator & start, const fwd_iterator & end );
		...
		public:
			/** Exposes the types and the static properties. */
			typedef structures::LowerTriangular structure;
			/**
			 * Indicates if a matrix needs to allocate data-related memory
			 * (for the internal container or functor object).
			 * False if it is a view over another matrix or a functor.
			 ...
			 * the type of objects of this class to the base class type.
			 */
			typedef typename internal::matrix_base_class< T, structures::LowerTriangular, Density::Dense, View, ImfR, ImfC, reference >::type base_type;
			// A general Structure knows how to define a reference to itself (which is an original reference view)
			// as well as other static views.
			template < view::Views view_tag, bool d=false >
			struct view_type;
			...
			template < bool d >
			struct view_type< view::original, d > {
				using type = Matrix< T, structures::LowerTriangular, Density::Dense, view::Original< self_type >, imf::Id, imf::Id, reference >;
			};

			template < bool d >
			struct view_type< view::gather, d > {
				using type = Matrix< T, structures::LowerTriangular, Density::Dense, view::Gather< self_type >, imf::Strided, imf::Strided, reference >;
			};

			template < bool d >
			struct view_type< view::transpose, d > {
				using type = Matrix< T, structures::UpperTriangular, Density::Dense, view::Transpose< self_type >, imf::Id, imf::Id, reference >;
			};
