...
#SBATCH --time=24:00:00                      # Time limit (6 hours)
#SBATCH --exclusive                           # Exclusive node allocation
#SBATCH --nodes=1                             # Request 1 node
#SBATCH --ntasks=1                            # Run a single task
#SBATCH --cpus-per-task=24                    # Request 24 CPU cores per task (matches OMP_NUM_THREADS=24)
...
export OMP_NUM_THREADS=24  # Set number of threads for OpenMP
