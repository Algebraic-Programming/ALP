			...
			MatrixFileReader( const std::string filename, const bool direct = true, const bool symmetricmap = true ) {
				...
				if( ! this->findHeader( infile ) ) {
					...
					std::cout << "MatrixFileReader: couldn't parse header, "
								 "inferring SNAP-based defaults; i.e."
								 "not symmetric, 0-based.\n";
#endif
...
// 			// internal::MatrixFileIterator< void > begin( const IOMode mode = SEQUENTIAL ) {
// 			// 	return cbegin( mode );
// 			// }

// 			// internal::MatrixFileIterator< void > end( const IOMode mode = SEQUENTIAL ) {
// 			// 	return cend( mode );
// 			// }

// 			// internal::MatrixFileIterator< void > cbegin( const IOMode mode = SEQUENTIAL ) {
// 			// 	return internal::MatrixFileIterator< void >( internal::MatrixFileReaderBase< void >::properties, mode );
// 			// }

// 			// internal::MatrixFileIterator< void > cend( const IOMode mode = SEQUENTIAL ) {
// 			// 	return internal::MatrixFileIterator< void >( internal::MatrixFileReaderBase< void, S >::properties, mode, true );
// 			// }
// 		};
