...
#include <graphblas/algorithms/amg/plugin/amgcl/amg2alp.hpp>
...
typedef amgcl::backend::builtin<double> AMGCL_backend;
typedef amgcl::amg2alp<
	AMGCL_backend,
...
#endif
		amgcl::save_levels( amg, Amat_data, Pmat_data, Rmat_data, Dvec_data );
