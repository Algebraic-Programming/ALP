...
#if ! defined _H_GRB_MLIR_EXEC
#define _H_GRB_MLIR_EXEC
...
namespace grb {
	...
	class Launcher< mode, mlir > {

	public:
		/** This implementation only accepts a single user process. It ignores \a
		 * hostname and \a port. */
