...
namespace grb {
	...
	namespace operators {
		...
		class is_strictly_upper : public internal::SingleMatrixCoordinatesOperatorBase<
			internal::is_strictly_upper< D, RIT, CIT, implementation >
		> {
		...
		class is_strictly_lower : public internal::SingleMatrixCoordinatesOperatorBase<
			internal::is_strictly_lower< D, RIT, CIT, implementation >
		> {
		...
		template<
			...
			enum Backend implementation = config::default_backend
		>
		class is_nonzero : public internal::SingleMatrixCoordinatesOperatorBase<
			internal::is_nonzero< D, RIT, CIT, implementation >
		> {
		...
		template<
			...
			enum Backend implementation = config::default_backend
		>
		class is_positive : public internal::SingleMatrixCoordinatesOperatorBase<
			internal::is_positive< D, RIT, CIT, implementation >
		> {
	...
	template< typename D1, typename D2, typename D3, enum Backend implementation >
	struct is_single_matrix_coordinates_operator< operators::is_strictly_upper< D1, D2, D3, implementation > > {
		static const constexpr bool value = true;
	};

	template< typename D1, typename D2, typename D3, enum Backend implementation >
	struct is_single_matrix_coordinates_operator< operators::is_strictly_lower< D1, D2, D3, implementation > > {
		static const constexpr bool value = true;
	};

	template< typename D1, typename D2, typename D3, enum Backend implementation >
	struct is_single_matrix_coordinates_operator< operators::is_nonzero< D1, D2, D3, implementation > > {
		static const constexpr bool value = true;
	};

	template< typename D1, typename D2, typename D3, enum Backend implementation >
	struct is_single_matrix_coordinates_operator< operators::is_positive< D1, D2, D3, implementation > > {
		static const constexpr bool value = true;
	};
