...
set( MLIR_BACKEND_INSTALL_DIR "${BINARY_LIBRARIES_INSTALL_DIR}/mlir" )
...
if ( WITH_MLIR_BACKEND )
  addBackendWrapperGenOptions( "mlir"
    COMPILE_DEFINITIONS "${MLIR_INCLUDE_DEFS}" "${MLIR_SELECTION_DEFS}"
    LINK_FLAGS "${MLIR_BACKEND_INSTALL_DIR}/lib${BACKEND_LIBRARY_OUTPUT_NAME}.a"
  )
endif()
