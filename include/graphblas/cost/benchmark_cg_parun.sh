...
#SBATCH --cpus-per-task=92                    # Request 92 CPU cores per task (matches OMP_NUM_THREADS=92)
...
export OMP_NUM_THREADS=92  # Set number of threads for OpenMP
export OMP_PROC_BIND=true
export OMP_PLACES={0:96}
